...
def math_level_subject_acc(answer_file):
    ...
    print(os.path.basename(answer_file), ':\t', results_dict['-Text Dominant'])
    print(os.path.basename(answer_file), ':\t', results_dict['-Text Lite'])
    print(os.path.basename(answer_file), ':\t', results_dict['-Vision Intensive'])
    print(os.path.basename(answer_file), ':\t', results_dict['-Vision Dominant'])
    print(os.path.basename(answer_file), ':\t', results_dict['-Vision Only'])
...
if __name__ == '__main__':
    ...
    parser.add_argument("--gt_file", type=str, default="/data/home/shan/code/GLIP-LLaVA/playground/MathVerse/testmini.json")
