...
def extract_choice(q, answer, i):
    ...
    pattern0_1 = r"Answer: ([A-D])"
    match = re.search(pattern0_1, answer)
    if match:
        return match.group(1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ground_truth_file", type=str, default="/data/home/shan/code/GLIP-LLaVA/playground/data/test_answers.jsonl")
    parser.add_argument("--predictions_file", type=str, default="/data/home/shan/Gllava-test_merged.jsonl")
    parser.add_argument("--question_file", type=str, default="/data/home/shan/code/GLIP-LLaVA/playground/data/test_questions.jsonl")
